!(function (t, e) {
  ...
  const b = () => {
    queueMicrotask(() => {
      (() => {
        const { slug: t, index: e } = v.parseURL(),
          i = xt.getInstance();
  ...
  class v extends g {
    ...
    onClose() {
      if ((this.timer && clearTimeout(this.timer), !0 !== v.hasSilentClose))
        try {
    ...
    static startFromUrl() {
      if (
        ((v.hasSilentClose = !1), xt.getInstance() || !1 === xt.defaults.Hash)
      )
        return;
      const { hash: t, slug: e, index: i } = v.parseURL();
      if (!e) return;
  ...
  Object.defineProperty(v, "defaults", {
    ...
    Object.defineProperty(v, "hasSilentClose", {
      enumerable: !0,
      configurable: !0,
      writable: !0,
      value: !1,
  ...
  class C {
    constructor(
      ...
      for (const t of [
        ...
        this[t] = this[t].bind(this);
      this.element.addEventListener("touchstart", this.onTouchStart, M),
        this.element.addEventListener("touchmove", this.onMove, M),
        this.element.addEventListener("touchend", this.onTouchEnd),
        this.element.addEventListener("touchcancel", this.onTouchEnd),
        this.element.addEventListener("mousedown", this.onPointerStart, M);
    }
    onPointerStart(t) {
    ...
    onTouchStart(t) {
      for (const e of Array.from(t.changedTouches))
        this.triggerPointerStart(new P(e), t);
      window.addEventListener("blur", this.onWindowBlur);
    }
    onMove(t) {
      const e = this.currentPointers.slice(),
        i =
          "changedTouches" in t
            ? Array.from(t.changedTouches).map((t) => new P(t))
            : [new P(t)],
        n = [];
      for (const t of i) {
    ...
    onPointerEnd(t) {
      (t.buttons > 0 && 0 !== t.button) ||
        (this.triggerPointerEnd(t, new P(t)),
    ...
    onTouchEnd(t) {
      for (const e of Array.from(t.changedTouches))
        this.triggerPointerEnd(t, new P(e));
    }
    ...
    stop() {
      this.element.removeEventListener("mousedown", this.onPointerStart, M),
        this.element.removeEventListener("touchstart", this.onTouchStart, M),
        this.element.removeEventListener("touchmove", this.onMove, M),
  ...
  const L = ["a", "b", "c", "d", "e", "f"],
    ...
    R = (t) => t && null !== t && t instanceof Element && "nodeType" in t,
    k = { a: 1, b: 0, c: 0, d: 1, e: 0, f: 0 },
    I = 1e5,
    D = 1e3;
  let F = null,
    j = null;
  class H extends f {
    get isTouchDevice() {
      return null === j && (j = window.matchMedia("(hover: none)").matches), j;
    }
    get isMobile() {
      return (
        null === F &&
          (F = /iPhone|iPad|iPod|Android/i.test(navigator.userAgent)),
        F
      );
    }
    get panMode() {
    ...
    get isContentLoading() {
      return this.content instanceof HTMLImageElement && !this.content.complete;
    }
    get isResting() {
    ...
    constructor(t, e = {}, i = {}) {
      ...
      if (
        ((this.container = t),
        this.initContent(),
        this.attachPlugins(Object.assign(Object.assign({}, H.Plugins), i)),
        this.emit("init"),
        ...
        if (this.option("spinner")) {
          ...
          const e = s(l);
          t.contains(this.content)
            ? (this.spinner =
                (null === (n = this.content.parentElement) || void 0 === n
                  ? void 0
                  : n.insertBefore(e, this.content)) || null)
            : (this.spinner = t.appendChild(e));
        }
        this.emit("beforeLoad"),
          this.content.addEventListener("load", this.onLoad),
          this.content.addEventListener("error", this.onError);
      } else
        queueMicrotask(() => {
          this.enable();
        });
    ...
    attachObserver() {
      ...
      this.resizeObserver ||
        ...
        (this.resizeObserver = new ResizeObserver((t) => {
          if (e)
            if (
              Math.abs(this.containerRect.width - t[0].contentRect.width) <
                0.1 &&
              Math.abs(this.containerRect.height - t[0].contentRect.height) <
                0.1
            )
    ...
    enable() {
      ...
      for (const t of L) this.current[t] = this.target[t] = e[t];
      this.updateMetrics(),
        this.attachObserver(),
        this.attachEvents(),
        (this.state = A.Ready),
    ...
    onPointerDown(t, e, i) {
      ...
      return (
        ...
        this.targetScale < this.minScale + 1e-5
          ? (this.stop(),
    ...
    onPointerMove(t, e, i) {
      ...
      let p =
        this.targetScale < this.minScale + 1e-5 && this.option("lockAxis");
      ...
      if (
        (x(t.target, this.content) && ((p = "x"), (this.dragOffset.y = 0)),
        p &&
          "xy" !== p &&
          this.lockedAxis !== p &&
          this.targetScale < this.minScale + 1e-5)
      ...
      f < 0.5 * g && (h = Math.max(h, g)),
        ...
        "y" === this.lockedAxis && f < g + 1e-5 && (d = 0),
        "x" === this.lockedAxis && f < g + 1e-5 && (u = 0),
        this.applyChange({
          originX: a,
          originY: r,
          panX: d,
    ...
    startDecelAnim() {
      ...
      Math.abs(this.dragOffset.x) < u &&
        Math.abs(this.dragOffset.y) < u &&
        ((a = r = 0), (l = c = 0)),
    ...
    updateMetrics(t = !1) {
      if (!this || this.state === A.Destroy) return;
    ...
    getBounds() {
      ...
      if (!0 === r || (this.lockedAxis && r === this.lockedAxis))
        ...
        let { containerRect: t, contentRect: r } = this,
          l = w(this.contentRect.fitWidth * this.targetScale, D),
          c = w(this.contentRect.fitHeight * this.targetScale, D),
    ...
    updateControls() {
      ...
      let i =
          {
            toggleMax:
              this.targetScale > this.maxScale ? this.minScale : this.maxScale,
            toggleCover:
              this.targetScale > this.coverScale
                ? this.minScale
                : this.coverScale,
            toggleZoom:
              this.targetScale > this.fullScale
                ? this.minScale
                : this.fullScale,
      ...
      let r = n && i > this.minScale,
        l = !n && !a && s && i === this.minScale;
      E(e, this.cn("canZoomIn"), r),
        E(e, this.cn("canZoomOut"), l),
        E(e, this.cn("isDraggable"), a);
    ...
    applyChange({
      ...
      this.rAF && (cancelAnimationFrame(this.rAF), (this.rAF = null)),
        (this.isBouncingX = !1),
        (this.isBouncingY = !1);
      for (const t of L) this.velocity[t] = 0;
      (this.friction = a || 0), (this.ignoreBounds = c);
      const { current: d } = this,
        u = d.e,
        p = d.f,
        m = this.getMatrix(this.target);
      let f = new DOMMatrix().translate(u, p).translate(s, o).translate(t, e);
      if (this.option("zoom")) {
        if (!c) {
      ...
      (f = f.translate(-s, -o).translate(-u, -p).multiply(m)),
        n && (f = f.rotate(n)),
        r && (f = f.scale(-1, 1)),
        l && (f = f.scale(1, -1));
      for (const t of L)
        ("a" == t || "d" == t) && f[t] > this.minScale + 1e-5
          ? (this.target[t] = f[t])
          : (this.target[t] = w(f[t], D));
      (this.targetScale < this.scale ||
        Math.abs(i - 1) > 0.1 ||
        "mousemove" === this.panMode ||
        !1 === h) &&
        ...
        this.isResting || ((this.state = A.Panning), this.requestTick());
    }
    stop(t = !1) {
      if (this.state !== A.Init && this.state !== A.Destroy) {
        this.rAF && (cancelAnimationFrame(this.rAF), (this.rAF = null)),
          (this.isBouncingX = !1),
          (this.isBouncingY = !1);
        for (const e of L)
        ...
        this.setTransform(),
          this.isTicking && (this.emit("endAnimation"), this.updateControls()),
          (this.isTicking = !1),
          (this.isDragging = !1),
          (this.lockedAxis = !1),
          (this.state = A.Ready);
    ...
    requestTick() {
      this.isTicking || (this.emit("startAnimation"), this.updateControls()),
        (this.isTicking = !0),
    ...
    panWithMouse(t, e = this.option("mouseMoveFriction")) {
      if (((this.prevMouseMoveEvent = t), "mousemove" !== this.panMode || !t))
        return;
      if (this.targetScale < this.minScale + 1e-5) return;
    ...
    zoomWithWheel(t) {
      if (this.state === A.Destroy || this.state === A.Init) return;
    ...
    toggleMax(t) {
      this.zoomTo(this.targetScale > 0.9 * this.maxScale ? "fit" : "max", t);
    }
    toggleCover(t) {
      this.zoomTo(
        this.targetScale > 0.9 * this.coverScale ? "fit" : "cover",
        t
      );
    }
    iterateZoom(t) {
    ...
    zoomTo(
      ...
      if (this.isContentLoading || this.state === A.Destroy) return;
      this.stop();
  ...
  Object.defineProperty(H, "defaults", {
    ...
    Object.defineProperty(H, "Plugins", {
      enumerable: !0,
      configurable: !0,
      writable: !0,
      value: {},
  ...
  class N extends g {
    ...
    onClose() {
      ...
      if (!r) return;
      (this.instance.state = d.CustomClosing),
      ...
      const { x: c, y: h, scale: u, opacity: p } = r;
      if (p) {
        const t = ((t, e, i, n) => {
          const s = e - t,
            o = n - i;
      ...
      return new Promise((n, s) => {
        ...
        t.panzoom = new H(
          ...
          i({}, this.option("Panzoom") || {}, {
            content: r,
            width: o.optionFor(t, "width", "auto"),
            height: o.optionFor(t, "height", "auto"),
            wheel: () => {
    ...
    getZoomInfo(t) {
      ...
      let { top: c, left: h, fitWidth: u, fitHeight: p } = s.contentRect;
      if (!(r && l && u && p)) return !1;
      const m = r / u,
        f = s.container.getBoundingClientRect();
      (c += f.top), (h += f.left);
      const g = -1 * (h + 0.5 * u - (a + 0.5 * r)),
        b = -1 * (c + 0.5 * p - (o + 0.5 * l));
  ...
  class Y extends g {
    onInitSlides(t, e) {
      for (const t of e.slides) this.processType(t);
    }
    onCreateSlide(t, e, i) {
      this.setContent(i);
    }
    ...
    onSelectSlide(t, e, i) {
      i.state === u.Ready && this.playVideo();
    }
        ...
        ("string" == typeof e &&
          ("#" === e.charAt(0)
            ...
            : (n = e.match(
              ...
              (i = "map")))),
        (t.type = i || this.instance.option("defaultType"));
    }
    setContent(t) {
      const e = this.instance.optionFor(t, "src") || "";
      if (t && t.type && e) {
    ...
    attach() {
      this.instance.on("Carousel.initSlides", this.onInitSlides),
        this.instance.on("Carousel.createSlide", this.onCreateSlide),
        this.instance.on("Carousel.removeSlide", this.onRemoveSlide),
    ...
    detach() {
      this.instance.off("Carousel.initSlides", this.onInitSlides),
        this.instance.off("Carousel.createSlide", this.onCreateSlide),
        this.instance.off("Carousel.removeSlide", this.onRemoveSlide),
  ...
  class Z extends g {
    ...
    set() {
      ...
      (this.state = "play"), B(this.instance.container, "has-autoplay");
  ...
  const G = {
    ...
    parentEl: null,
    thumbTpl:
      '<button class="f-thumbs__slide__button" tabindex="0" type="button" aria-label="{{GOTO}}" data-carousel-page="%i"><img class="f-thumbs__slide__img" data-lazy-src="{{%s}}" alt="" /></button>',
    type: "modern",
  };
  var U;
  !(function (t) {
  ...
  let K = class extends g {
    ...
    onTransformM() {
      ...
      E(e, this.cn("isResting"), n.state !== A.Init && n.isResting);
      let s = 0,
        o = 0,
        a = 0;
      for (const e of t.slides) {
        ...
        if (!i) continue;
        (o = 0),
          E(i, this.cn("isSelected"), t === this.instance.page),
    ...
    getModernThumbPos(t) {
      ...
      let o =
        ...
        this.thumbExtraGap +
        0.5 * (e.thumbWidth || 0);
      return (o -= s > n ? 0.5 * n : 0.5 * s), w(o || 0, 1);
    }
    build() {
      const t = this.instance,
        e = t.container,
      ...
      if (i) {
        ...
        if (e < i) return this.cleanup(), void (this.state = U.Disabled);
      }
      ...
      this.type = n;
      const s = document.createElement("div");
      B(s, this.cn("container")), B(s, `is-${n}`);
      const o = this.option("parentEl");
      o ? o.appendChild(s) : e.after(s),
        (this.container = s),
        B(e, this.cn("hasThumbs"));
    ...
    cleanup() {
      this.carousel && this.carousel.destroy(),
        ...
        (this.track = null),
        (this.state = U.Init),
        q(this.instance.container, this.cn("hasThumbs"));
    }
    attach() {
  ...
  const J = Object.assign(Object.assign({}, G), {
    key: "t",
    showOnStart: !0,
    parentEl: null,
  });
  class Q extends g {
    ...
    onInit() {
      ...
      n &&
        ((e.options.Thumbs = i({}, this.options, {
          ...
          Carousel: { Sync: { friction: t.option("Carousel.friction") } },
          on: {
            ready: (t) => {
              var e, i;
              this.hidden &&
        ...
        e.attachPlugins({ Thumbs: K }),
        (this.ref = e.plugins.Thumbs),
        this.option("showOnStart") ||
          ((this.ref.state = U.Hidden), (this.hidden = !0)));
    }
    onResize() {
      var t;
    ...
    refresh() {
      const t = this.ref;
      if (!t || t.state === U.Disabled) return;
      const e = t.container,
        i = (null == e ? void 0 : e.firstChild) || null;
      e &&
        i &&
        i.childNodes.length &&
        ((e.style.height = `${i.getBoundingClientRect().height}px`),
        e.offsetHeight);
    }
    attach() {
    ...
    onReady(t) {
      ...
      if ((o && (r = this.createContainer()), r)) {
        for (const [t, e] of Object.entries(a)) {
          const i = document.createElement("div");
          B(i, "fancybox__toolbar__column is-" + t);
        ...
        e &&
          ...
          e.click &&
            n.addEventListener("click", (t) => {
              t.preventDefault(),
                t.stopPropagation(),
                "function" == typeof e.click && e.click(t);
            }));
      }
  ...
  class ut extends g {
    ...
    refresh() {
      ...
      if (((l = l || r.firstChild), o && l)) {
        ...
        B(t, this.cn("isPrev")), B(e, this.cn("isBeforePrev"));
        const i = l.nextElementSibling,
          n = i && i.nextElementSibling;
        B(i, this.cn("isNext")), B(n, this.cn("isAfterNext"));
      }
      this.isDynamic = o;
    }
    createItem(t = 0) {
  ...
  class mt extends g {
    ...
    onNavClick(t, e, i) {
      ...
      a.page !== h && a.slideTo(h);
      const d = r.getPageForSlide(c);
      r.page !== d &&
        r.slideTo(d, {
          friction:
            null ===
    ...
    onTargetChange() {
      ...
      e.slideTo(n), this.markSelectedSlide(i);
    }
    markSelectedSlide(t) {
      const { nav: e } = this;
      if (!e) return;
  ...
  class gt extends f {
    ...
    constructor(t, e = {}, i = {}) {
      if (
        ...
        throw new Error("No Element found");
      (this.container = t),
        (this.slideNext = n(this.slideNext.bind(this), 175)),
        (this.slidePrev = n(this.slidePrev.bind(this), 175)),
        (this.userOptions = e),
        (this.userPlugins = i),
        queueMicrotask(() => {
          this.processOptions();
    ...
    initLayout() {
      ...
      B(t, this.cn("container")),
        E(t, e.isLTR, !this.isRTL),
        E(t, e.isRTL, this.isRTL),
        E(t, e.isVertical, !this.isHorizontal),
        E(t, e.isHorizontal, this.isHorizontal);
    ...
    setInitialPosition() {
      ...
      (this.track.style.transform = `translate3d(${i}, ${n}, 0) scale(1)`),
    ...
    initPanzoom() {
      ...
      (this.panzoom = new H(
        ...
        this.panzoom.on("touchStart", (t, e) => {
    ...
    processPages() {
      ...
      return (
        t.forEach((t) => {
          ...
          a && e.pos === a.pos
            ? ((a.dim += e.dim), (a.slides = [...a.slides, ...e.slides]))
            : ((e.index = o.length), (a = e), o.push(e));
        }),
        o
      );
    }
    ...
    createSlideEl(t) {
      ...
      B(e, this.cn("slide")), B(e, t.class), t.html && (e.innerHTML = t.html);
      const i = [];
    ...
    removeSlideEl(t, e = !1) {
      const i = t.el;
      if (!i) return;
      if ((q(i, this.cn("isSelected")), t.isDom && !e))
    ...
    transitionTo(t = 0, e = this.option("transition")) {
      ...
      const r = n.isResting;
      B(this.container, this.cn("inTransition"));
          ...
          i.el &&
            ...
            this.pages[this.page].slides.includes(i)
              ? (i.el.classList.contains(e) ||
                  (B(i.el, e), this.emit("selectSlide", i)),
                i.el.removeAttribute(t))
              : (i.el.classList.contains(e) &&
                  (q(i.el, e), this.emit("unselectSlide", i)),
        ...
        (e.src = e.dataset.lazySrcset || e.dataset.lazySrc || ""),
          ...
          setTimeout(() => {
            !e.complete &&
              e.parentNode &&
              t.el &&
              ((i = s(l)), e.parentNode.insertBefore(i, e));
          }, 300);
      }
    ...
    clearTransitions() {
      this.inTransition.clear(), q(this.container, this.cn("inTransition"));
    ...
    onDecel(t, e = 0, i = 0) {
      ...
      let { pageIndex: d } = this.getPageFromPosition(h);
      if (a || Math.abs(s) < 10) {
        const e = t.target[c] * (this.isRTL && this.isHorizontal ? 1 : -1),
          { pageIndex: i } = this.getPageFromPosition(e);
        r = i;
      } else (r = this.isRTL && this.isHorizontal ? (s < 0 ? d - 1 : d + 1) : s < 0 ? d + 1 : d - 1), n || (r = Math.max(0, Math.min(r, this.pages.length - 1)));
      if (
        (n && (l = Math.floor(r / o) || 0),
        (r = ((r % o) + o) % o),
        a && t.dragOffset["e" === c ? "x" : "y"])
      );
      else {
        const e = this.contentDim;
        let i =
          (this.pages[r].pos + l * e) *
          (this.isRTL && this.isHorizontal ? 1 : -1);
        if (
          Math.abs(t.target[c] - i) < 0.1 &&
          t.lockedAxis === ("e" == c ? "y" : "x")
        )
          return;
        ...
        n
          ? (t.preventDefault(),
            ...
            e &&
              ...
              this[n](i && "slideTo" === n ? i.carouselPage : void 0))
          : this.emit("click", t);
    }
    onSlideTo(t) {
      const e = t.detail || 0;
    ...
    updateMetrics() {
      ...
      for (const [t, n] of this.slides.entries()) {
        ...
        !n.el && e
          ? ((s = e.dim), (o = e.gap))
          : (({ dim: s, gap: o } = this.getSlideMetrics(n)), (e = n)),
          (n.dim = w(s, 1e3)),
          (n.gap = w(o, 1e3)),
          (n.pos = w(i, 1e3)),
          (i += s),
          (this.isInfinite || t < this.slides.length - 1) && (i += o);
      }
      this.viewport &&
        (this.viewportDim = w(this.viewport.getBoundingClientRect()[t], 1e3)),
        (this.contentDim = w(i, 1e3)),
        this.panzoom &&
          ((this.panzoom.contentRect[t] = this.contentDim),
          (this.panzoom.contentRect[
    ...
    getPageFromPosition(t) {
      ...
      a && (t += 0.5 * e),
        this.isInfinite ||
          (t = Math.max(
            this.slides[0].pos,
            Math.min(t, this.slides[this.slides.length - 1].pos)
          ));
      ...
      let c = this.slides[this.slides.length - 1],
        h = this.slides.find((e) => {
          const i = t + (c && !a ? 0.5 * c.dim : 0);
          return (c = e), e.pos <= i && e.pos + e.dim + e.gap > i;
        });
      return (
        h || (h = this.slides[this.slides.length - 1]),
  ...
  class xt extends f {
    ...
    constructor(t = [], e = {}, i = {}) {
      super(e),
        ...
        (this.onWheel = n(this.onWheel.bind(this), 300)),
        (this.fsAPI = (() => {
          let t,
            e = "",
            i = "",
    ...
    initLayout() {
      const t = this.option("parentEl") || document.body,
        e = s(this.localize(this.option("tpl.main") || ""));
      e &&
      ...
      s.on("*", (t, e, ...i) => {
        ...
        this.option("dragToClose") &&
          ...
          s.on("Panzoom.touchEnd", (t, e, i) => {
            ...
            "y" === e.lockedAxis &&
            (n >= 200 || (n >= 50 && e.dragOffset.time < 300))
    ...
    onClick(t) {
      ...
      if (
        ...
        return;
      if (i.closest(".f-spinner") || i.closest("[data-fancybox-close]"))
        return t.preventDefault(), void this.close(t);
      if (i.closest("[data-fancybox-prev]"))
        return t.preventDefault(), void this.prev();
      if (i.closest("[data-fancybox-next]"))
      ...
      if (i.closest(".fancybox__content")) {
        if (s) {
          if (s.closest("[contenteditable]")) return;
          i.matches(r) || s.blur();
        }
        if ((o = window.getSelection()) && "Range" === o.type) return;
        n = this.option("contentClick");
      } else i.closest(".fancybox__carousel") && !i.matches(r) && (n = this.option("backdropClick"));
      var o;
      "close" === n
        ? (t.preventDefault(), this.close(t))
        : "next" === n
        ? (t.preventDefault(), this.next())
        : "prev" === n && (t.preventDefault(), this.prev());
    }
    onWheel(t) {
      if ((this.emit("wheel", t), t.defaultPrevented)) return;
      const e = this.option("wheel", t);
      if ("close" === e) t.preventDefault(), this.close(t);
      else if ("slide" === e) {
        const e = Math.max(
          -1,
          Math.min(1, -t.deltaY || -t.deltaX || -t.detail)
        );
        t.preventDefault(), this[e > 0 ? "next" : "prev"]();
      }
    }
    onKeydown(t) {
    ...
    manageCloseBtn(t) {
      ...
      const i = s(this.localize(this.option("tpl.closeButton")));
      (t.closeBtnEl = t.contentEl.appendChild(i)),
        t.el && B(t.el, "has-close-btn");
    }
    manageCaption(t) {
      var e, i, n;
    ...
    focus(t) {
      ...
      if (
        ...
        return;
      const c = l && l.state === u.Ready ? l.el : null;
      if (!c || c.contains(i)) return;
      t && t.cancelable && t.preventDefault(), (this.ignoreFocusChange = !0);
      const h = Array.from(s.querySelectorAll(r));
      let d,
        p = [s];
      for (let t of h) {
        ...
        e && (i || n)
          ? (p.push(t),
            ...
            (t.hasAttribute("autoFocus") || (!d && i)) && (d = t))
      ...
      t
        ? (!n || p.indexOf(n) < 0) &&
          ...
          p.length &&
            (i === vt
              ? (m = p[0])
              : (this.lastFocus !== s && i !== bt) || (m = p[p.length - 1])))
        : this.option("autoFocus") && d
        ? (m = d)
        : i && p.indexOf(i) < 0 && (m = s),
        m &&
          ((t) => {
    ...
    showLoading(t) {
      ...
      e.classList.add("is-loading"),
        ...
        t.spinnerEl ||
          setTimeout(() => {
            if (!this.isClosing() && !t.spinnerEl && t.state === u.Loading) {
              let i = s(l);
    ...
    hideLoading(t) {
      ...
      this.isClosing()
        ...
        : (e.classList.remove("is-loading"),
          ...
          t.state === u.Loading &&
            (this.emit("loaded", t), (t.state = u.Ready)));
    }
    setError(t, e) {
      if (this.isClosing()) return;
      this.emit("error"),
    ...
    proceedClose(t, e) {
      ...
      if (
        (s &&
          ...
          this.option("animated") && B(s, "is-animated"),
        ...
        for (const t of o.slides) {
          (t.state = u.Closing), this.hideLoading(t);
          const e = t.contentEl;
          e && this.stop(e);
    ...
    static fromEvent(t) {
      ...
      return m && m.options.trigger && l.indexOf(m.options.trigger) > -1
        ? void 0
        : (e && (c.startIndex = l.indexOf(e)), xt.fromNodes(l, c));
    }
